...
<header class="topo-site">
    ...
    <a   href="pg-index.php" class="logo">
        <img src="logo-amarelo_roxo-removebg.png" alt="logo" width="80">
    </a>
    <!-- FIM DA LOGO MARCA -->

    <!-- INICIO MENU -->
    <nav class="menu-site">
        <a href="4pagina-Cadastro_Produtos.html"> Registrar Produtos</a>
        <a href="5pagina-Tabela_Produtos.php"> Editar Produtos</a>
        <a href="5pagina-Tabela_Clientes.php">Tabela de Clientes</a>
        <a href="1pagina-Index.php"><i class='bx bx-left-arrow-circle'></i>Voltar</a><br><br>
    </nav>
    <!-- FIM MENU -->
</header>
